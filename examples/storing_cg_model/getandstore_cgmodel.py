...
total_simulation_time = 0.0002 * unit.nanosecond  # Units = picoseconds
simulation_time_step = 0.1 * unit.femtosecond
total_steps = total_steps = int(np.floor(total_simulation_time/simulation_time_step))
...
# store the model.
cgmodel.export("cgmodel.pkl")

#retrieve it
cgmodel2 = pickle.load(open( "cgmodel.pkl", "rb" ))
